...
function savecom(usuario, condio, idr) {
    ...
    if (condio != 'anular_cheques') {
        ...
        datainputs = getinputsval(['datedoc', 'datecont', 'codofi', 'codofi2', 'cantidad', 'numdoc', 'paguese', 'numletras', 'numcheque', 'glosa', 'totdebe', 'tothaber'])
        dataselects = getinputsval(['negociable', 'bancoid', 'cuentaid'])
    }
    generico([datainputs, datainputsd, datainputsh, datacuentas, datafondos], dataselects, [], condio, idr, [usuario, idr]);
}
//#endregion ---------------------------------------------------------------------------------------------------------------------------------------------------------------
