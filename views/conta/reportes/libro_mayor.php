...
/*  ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    +++++++++++++++++++++++++++++++++++++++++ VALIDACIONES +++++++++++++++++++++++++++++++++++++++++++++++++++
    +++ ([[`finicio`,`ffin`,idcuenta],[`codofi`,`fondoid`],[`rcuentas`,`rfondos`,`ragencia`],[ $idusuario]] ++
    ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ */
...
$strquery = "SELECT * from ctb_diario_mov WHERE estado=1 " . $condi . " ORDER BY id_ctb_nomenclatura,feccnt";//comentar esta query y usar la de arriba, si necesitan que la partida de apertura sea el saldo inicial
