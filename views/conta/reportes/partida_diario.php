...
INNER JOIN clhpzzvb_bd_general_coopera.ctb_tipo_poliza AS tp ON tp.id=dia.id_ctb_tipopoliza
...
while ($it < count($ctbmovdata)) {
    ...
    $nomcuenta = utf8_decode($ctbmovdata[$it]["cdescrip"]);
...
$pdf->MultiCell(0, $tamanio_linea + 1, 'CONCEPTO: ' . utf8_decode($ctbmovdata[0]["glosa"])); // cuenta
$pdf->firmas(2,['ELABORADO POR','CONTADOR']);
