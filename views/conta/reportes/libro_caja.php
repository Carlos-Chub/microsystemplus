...
$strquery = "SELECT * from ctb_diario_mov WHERE estado=1 AND id_ctb_nomenclatura IN (SELECT id_nomenclatura_caja FROM tb_agencia) " . $condi . " ORDER BY id_ctb_nomenclatura,feccnt";
