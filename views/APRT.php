    ...
    <body class="<?= ($_SESSION['background'] == '1') ? 'dark' : ''; ?>">
        ...
        <section class="home">
            <div class="container" style="max-width: none !important;">
                ...
                AND tbo.rama='G' AND  tbo.id=3  ORDER BY tbo.orden, tbs.orden, tbm.orden ASC";
        ...
        <?php include_once "../src/cris_modales/fun_modal.php"; ?>
        <?php include_once "../src/cris_modales/mdls_aport.php"; ?>
        <?php include_once "../src/cris_modales/mdls_cli.php"; ?>
        <?php include_once "../src/cris_modales/mdls_nomenclatura.php"; ?>
