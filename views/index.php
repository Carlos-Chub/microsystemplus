...
<body class="<?= ($_SESSION['background'] == '1') ? 'dark' : ''; ?>">
    <?php
        ...
        $consulta = mysqli_query($conexion, "SELECT cope.log_img AS imagenEnti, cope.nomb_cor AS nomAge
                ...
                <div class="d-flex flex-column h-100">
                    <div class="flex-grow-1">
                      ...
                      font-size: x-large;'> Sistema orientado para microfinanzas </p>
                                ...
                                <div class="col-auto">
                                    <iframe width="500" height="350" src="https://www.youtube.com/embed/xmislQDO1SQ"
                                        title="Presentación de MicroSystem+" frameborder="0"
