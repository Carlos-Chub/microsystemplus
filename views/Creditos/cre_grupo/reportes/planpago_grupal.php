...
function printpdf($datos, $info)
{
    ...
    $emailins = utf8_decode($info[0]["emai"]);
    ...
    $pdf->CellFit($ancho_linea + 10, $tamanio_linea, utf8_decode('Ciclo '), 0, 0, 'L', 0, '', 1, 0);
    ...
    $pdf->Ln(6);
    $pdf->SetFont($fuente, 'B', 10);
    $pdf->CellFit($ancho_linea + 10, $tamanio_linea, utf8_decode('Nombre de grupo:'), 0, 0, 'L', 0, '', 1, 0);
    $pdf->SetFont($fuente, '', 9);
    $nombreGrupo = ($datos[0]['NombreGrupo'] == '' || $datos[0]['NombreGrupo'] == null) ? ' ' : utf8_decode(mb_strtoupper($datos[0]['NombreGrupo'], 'utf-8'));
    $pdf->CellFit($ancho_linea + 30, $tamanio_linea, $nombreGrupo, 0, 0, 'L', 0, '', 1, 0);
    $pdf->Ln(6);
    $pdf->SetFont($fuente, 'B', 10);
    $pdf->CellFit($ancho_linea + 10, $tamanio_linea, utf8_decode('Codigo de Grupo:'), 0, 0, 'L', 0, '', 1, 0);
    $pdf->SetFont($fuente, '', 9);
    ...
    $pdf->SetFont($fuente, '', 9);
    $nombreGrupo = ($datos[0]['direccion'] == '' || $datos[0]['direccion'] == null) ? ' ' : utf8_decode(mb_strtoupper($datos[0]['direccion'], 'utf-8'));
    $pdf->CellFit($ancho_linea + 30, $tamanio_linea, $nombreGrupo, 0, 0, 'L', 0, '', 1, 0);
    $pdf->Ln(6);
    $pdf->SetFont($fuente, 'B', 10);
    $pdf->CellFit($ancho_linea + 10, $tamanio_linea, utf8_decode('Fecha de Apertura:'), 0, 0, 'L', 0, '', 1, 0);
    $pdf->SetFont($fuente, '', 9);
    ...
    $pdf->Ln(6);
    $pdf->SetFont($fuente, 'B', 10);
    $pdf->CellFit($ancho_linea + 10, $tamanio_linea, utf8_decode('Monto desembolsado:'), 0, 0, 'L', 0, '', 1, 0);
    $pdf->SetFont($fuente, '', 9);
    $nombreGrupo = ($datos[0]['monto_desembolsado'] == '' || $datos[0]['monto_desembolsado'] == null) ? ' ' : ($datos[0]['monto_desembolsado']);
    $pdf->CellFit($ancho_linea + 30, $tamanio_linea, $nombreGrupo, 0, 0, 'L', 0, '', 1, 0);
    $pdf->Ln(6);
    $pdf->SetFont($fuente, 'B', 10);
    $pdf->CellFit($ancho_linea + 10, $tamanio_linea, utf8_decode('Saldo Actual:'), 0, 0, 'L', 0, '', 1, 0);
    $pdf->SetFont($fuente, '', 9);
    $saldo_actual = 0;
    ...
    $pdf->Ln(6);
    $pdf->SetFont($fuente, 'B', 10);
    $pdf->CellFit($ancho_linea + 10, $tamanio_linea, utf8_decode('Asesor:'), 0, 0, 'L', 0, '', 1, 0);
    $pdf->SetFont($fuente, '', 9);
    $nombreGrupo = ($datos[0]['analista'] == '' || $datos[0]['analista'] == null) ? ' ' : utf8_decode(mb_strtoupper($datos[0]['analista'], 'utf-8'));
    $pdf->CellFit($ancho_linea + 30, $tamanio_linea, $nombreGrupo, 0, 0, 'L', 0, '', 1, 0);
    $pdf->Ln(6);

    $pdf->Ln(6);
    $pdf->SetFont($fuente, 'b', 10);
    $pdf->CellFit(0, $tamanio_linea, utf8_decode(' '), 'B', 0, 'C', 0, '', 1, 0);
    $pdf->CellFit(0, $tamanio_linea, utf8_decode(' '), 0, 0, 'L', 0, '', 1, 0);
    $pdf->Ln(7);


    //cuerpo de la tabla 
    $pdf->SetFont($fuente, 'B', 9);
    $pdf->CellFit($ancho_linea + 2, $tamanio_linea, utf8_decode('Cuotas:'), 'B', 0, 'R', 0, '', 1, 0);
    $pdf->CellFit($ancho_linea + 10, $tamanio_linea, utf8_decode('fecha de Cuota:'), 'B', 0, 'R', 0, '', 1, 0);
    $pdf->CellFit($ancho_linea + 10, $tamanio_linea, utf8_decode('Monto capital:'), 'B', 0, 'R', 0, '', 1, 0);
    $pdf->CellFit($ancho_linea + 10, $tamanio_linea, utf8_decode('Monto Interes:'), 'B', 0, 'R', 0, '', 1, 0);
    $pdf->CellFit($ancho_linea + 10, $tamanio_linea, utf8_decode('Otros Montos:'), 'B', 0, 'R', 0, '', 1, 0);
    $pdf->CellFit($ancho_linea + 10, $tamanio_linea, utf8_decode('Cuota Total:'), 'B', 0, 'R', 0, '', 1, 0);
    $pdf->CellFit($ancho_linea + 15, $tamanio_linea, utf8_decode('Saldo Capital:'), 'B', 0, 'R', 0, '', 1, 0);
    $pdf->SetFont($fuente, '', 9);
    $pdf->Ln(6);
