...
?>
  ...
  <body class="<?= ($_SESSION['background'] == '1') ? 'dark' : ''; ?>">
    ...
    <section class="home">
      <div class="container" style="max-width: none !important;">
        ...
        <div class="btn-group" id="nav_group" role="group">
          ...
          <?php
          // PASAR ESTA CONSULTA EN VARIABLE
        ...
        AND tbo.rama='R' AND tbo.id=6 ORDER BY tbo.orden, tbs.orden, tbm.orden ASC";
    ...
    <?php include_once "../../src/cris_modales/mdls_credlin.php";
    include_once "../../src/cris_modales/mdls_grupos.php"; ?>
