...
?>
            ...
            <div class="card-body">
                    ...
                    <div class="row mb-3">
                        <div class="col-sm-6">
                            <div>
                                ...
                                <input type="text" class="form-control " id="name" value="<?php if ($bandera == "") echo $datos[0]["NombreGrupo"]; ?>" readonly>
                            </div>
                        </div>
                        <div class="col-sm-5">
                            <br>
                            <button type="button" onclick="loadconfig('any',['F'])" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#buscargrupo">
                    ...
                    <div class="row mb-3">
                        <div class="col-sm-6">
                            <div>
                                ...
                                <input type="text" class="form-control " id="name1" value="<?php if ($bandera == "") echo $datos[0]["direc"]; ?>" readonly>
                            </div>
                        </div>
                        <div class="col-sm-3">
                ...
                <div class="row contenedort">
                    ...
                    <div class="row crdbody">
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control" placeholder="00000-111111111111" id="numdoc" value="<?= $numrecibo ?>">
                        </div>
                        <div class="form-group col-md-4">
                ...
                <div class="row contenedort" style="background-image: url(https://mdbootstrap.com/img/Photos/new-templates/glassmorphism-article/img9.jpg);">
                    ...
                    ?>
                            <div class="accordion" id="cuotas">
                                <div class="accordion-item  border border-4 border-success rounded-4">
                                    <div class="row m-1" style="font-size: 0.80rem;">
                                        <div class="col-sm-3">
                                            <div class="row">
                                                ...
                                                <input id="<?php echo 'ccodcta' . $j; ?>" type="text" value="<?php echo $ccodcta; ?>" hidden>
                                                <span class="input-group-addon"><?php echo strtoupper($name); ?></span>
                                                <input id="<?php echo 'namecli' . $j; ?>" type="text" value="<?php echo $name; ?>" hidden>
                                            </div>
                                        </div>
                                        <div class="col-sm-2">
                                            <div class="row">
                                                <span class="input-group-addon">Otorgamiento</span>
                                                <span class="input-group-addon"><?php echo $fecdes; ?></span>
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                            <div class="row">
                                                <span class="input-group-addon">Otorgado</span>
                                                <span class="input-group-addon"><?php echo $capdes; ?></span>
                                            </div>
                                        </div>
                                        <div class="col-sm-2">
                                            <div class="row">
                                                <span class="input-group-addon">Saldo Capital</span>
                                                <span class="input-group-addon"><?php echo $salcap; ?></span>
                                            </div>
                                        </div>
                                        <div class="col-sm-2">
                                            <button style="font-size: small;" class="btn btn-outline-primary" onclick="mostrar_planpago('<?= $ccodcta; ?>'); printdiv5('nomcli2,codcredito2/A,A/'+'/#/#/#/#',['<?= $name; ?>','<?= $ccodcta; ?>']);" data-bs-toggle="modal" data-bs-target="#modal_plan_pago"><i class="fa-solid fa-rectangle-list me-2"></i>Plan de pago</button>
                                        </div>
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12">
                                                    <div>
                                                        <textarea style="height: auto;font-size: 12px;" class="form-control" id="concepto<?php echo $j; ?>" rows="1"><?= $concepto ?></textarea>
                                                        <!-- <input class="form-control" id="concepto<?php echo $j; ?>" type="text" value="<?= $concepto ?>"> -->
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <h2 class="accordion-header">
                                        <button id="<?php echo 'bt' . $j; ?>" onclick="opencollapse(<?php echo $j; ?>)" style="--bs-bg-opacity: .2;" class="accordion-button collapsed bg-<?php echo ($datacom[$j]["cuotaspen"][0]['atraso'] > 0) ? 'danger' : 'success'; ?>" data-bs-target="#<?php echo $idit; ?>" aria-expanded="false" aria-controls="<?php echo $idit; ?>">
                                            <div class="row" style="font-size: 0.80rem;">
                                                <div class="col-sm-2">
                                                    <span class="input-group-addon">Capital</span>
                                                    <input id="<?php echo 'capital' . $j; ?>" disabled min="0" onclick="opencollapse(-1)" onblur="summon(this.id)" type="number" step="0.01" class="form-control habi form-control-sm" value="<?php echo $sumcapital; ?>">
                                                </div>
                                                <div class="col-sm-2">
                                                    <span class="input-group-addon">Interes</span>
                                                    <input id="<?php echo 'interes' . $j; ?>" disabled min="0" onclick="opencollapse(-1)" onblur="summon(this.id)" type="number" step="0.01" class="form-control habi form-control-sm" value="<?php echo $suminteres; ?>">
                                                </div>
                                                <div class="col-sm-2">
                                                    <span class="input-group-addon">Mora</span>
                                                    <input id="<?php echo 'monmora' . $j; ?>" disabled min="0" onclick="opencollapse(-1)" onblur="summon(this.id)" type="number" step="0.01" class="form-control habi form-control-sm" value="<?php echo $summora; ?>">
                                                </div>
                                                <!-- <div class="col-sm-1">
                                                ...
                                                <div class="col-sm-2">
                                                    ...
                                                    <div class="input-group">
                                                        <input style="height: 10px !important;" id="<?php echo 'otrospg' . $j; ?>" disabled readonly onclick="opencollapse(-1);" onchange="summon(this.id)" type="number" step="0.01" class="form-control habi form-control-sm" value="<?= $sumotrospagos; ?>">
                                                        <span id="<?php echo 'lotrospg' . $j; ?>" title="Modificar detalle otros" class="input-group-addon btn btn-link" data-bs-toggle="modal" data-bs-target="#modalgastos<?php echo $j; ?>" onclick="opencollapse(-1);"><i class="fa-solid fa-pen-to-square"></i></span>
                                                    </div>
                                                </div>
                                                <div class="col-sm-2">
                                                    <span class="input-group-addon">Total</span>
                                                    <input id="<?php echo 'totalpg' . $j; ?>" readonly onclick="opencollapse(-1)" type="number" step="0.01" class="form-control habi form-control-sm" value="<?php echo $total; ?>">
                                                </div>
                                                <div class="col-sm-1">
                                                    <div class="form-check form-switch">
                                                        <br>
                                                        <input onclick="opencollapse('<?php echo 's' . $j; ?>');" class="form-check-input" type="checkbox" role="switch" id="<?php echo 's' . $j; ?>" title="Modificar Cantidades">
                                                    </div>
                                                </div>
                                            </div>
                                        </button>
                                                            ...
                                                            <div class="row" style="font-size: 0.80rem;">
                                                                ...
                                                                <div class="col-sm-2">
                                                                    <div class="row">
                                                                        ...
                                                                        <span class="input-group-addon badge text-bg-<?php echo $variables[$estado - 1][0]; ?>"><?php echo  $variables[$estado - 1][1]; ?></span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </li>
                            ...
                            <!-- Modal -->
                            <div class="modal fade " id="modalgastos<?php echo $j; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
                                        ...
                                        <div class="modal-body">
                                            <table class="table" id="tbgastoscuota<?php echo $j; ?>" class="display" style="width:100%">
                                                ...
                                                <tbody id="categoria_tb">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="row d-flex justify-content-end">
                                                                ...
                                                                <input onkeyup="sumotros(<?php echo $j; ?>)" style="text-align: right;" id="DS" type="number" step="0.01" class="form-control form-control-sm inputNoNegativo" value="<?= $sumotrospagos; ?>" data-j="<?php echo $j; ?>">
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <?php
													...
													WHERE cre.CCODCTA='" . $ccodcta . "' AND pro.tipo_deCobro=2";
        ...
        <script>
            ...
            function guardar_pagos_grupales(cant, idusuario, idgrup, ciclo, idfondo, idagencia, summora) {
                ...
                var verificamora = (morainput.toFixed(2) != summora.toFixed(2)) ? 1 : 0; //una manera vaga de verificar pero por lo pronto
