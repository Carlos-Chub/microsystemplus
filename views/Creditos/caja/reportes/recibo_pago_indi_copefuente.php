...
function recibo($pdf, $registro, $hoy, $usuario,$info)
{
    ...
    $pdf->SetFont($fuente, '', 11);
    $pdf->CellFit($ancho_linea2 + 48, $tamanio_linea + 1, utf8_decode(mb_strtoupper($registro[0][2], 'utf-8')), 0, 0, 'L', 0, '', 1, 0);
    ...
    $pdf->Ln(15);
    $pdf->CellFit(0, $tamanio_linea + 1,  utf8_decode(utf8_decode('USUARIO:' . $usuario)), 0, 0, 'L', 0, '', 1, 0);
