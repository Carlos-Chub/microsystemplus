...
try {
    ...
    $resultdetalle = $database->getAllResults("SELECT cd.*,(SELECT tg.nombre_gasto FROM cre_tipogastos tg INNER JOIN cre_productos_gastos cgg ON cgg.id_tipo_deGasto=tg.id WHERE cgg.id=cd.id_concepto ) concepto FROM credkar_detalle cd WHERE cd.id_credkar IN 
