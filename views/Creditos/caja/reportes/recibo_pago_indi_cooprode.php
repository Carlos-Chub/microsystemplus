...
$pdf->CellFit($ancho_linea2 - 5, $tamanio_linea + 1, ' ', 0, 0, 'L', 0, '', 1, 0);
$pdf->CellFit($ancho_linea2 + 77, $tamanio_linea + 1, utf8_decode(mb_strtoupper($registro[0][2], 'utf-8')), 0, 0, 'L', 0, '', 1, 0);
$pdf->Ln(14);
  ...
  //  $pdf->CellFit($ancho_linea2-10 , $tamanio_linea + 1, '  ', 0, 0, 'L', 0, '', 1, 0);
    ...
    $pdf->MultiCell($ancho_linea2 + 40, $tamanio_linea * 2, utf8_decode(mb_strtoupper($registro[0][5], 'utf-8')), 0, 'L');
    ...
    //USUARIO
    $pdf->CellFit($ancho_linea2 , $tamanio_linea + 1, ' ', 0, 0, 'L', 0, '', 1, 0);
    $pdf->CellFit($ancho_linea2+50 , $tamanio_linea + 2, 'USUARIO:' . utf8_decode(utf8_decode($usuario)), 0, 0, 'C', 0, '', 1, 0);
}