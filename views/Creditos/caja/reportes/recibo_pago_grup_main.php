...
/*     $oficina = "Coban";
    ...
    class PDF extends FPDF
    {
        ...
        function Header()
        {
            ...
            $this->Cell($ancho_linea, 6, date("d-m-Y", strtotime($this->datos[0]["DFecApr"])), 'B', 0, 'L');

            $this->Cell($ancho_linea * 2, 6, 'VENCIMIENTO:', '', 0, 'R');
            $this->Cell($ancho_linea, 6, date("d-m-Y", strtotime($this->datos[0]["DFecVen"])), 'B', 0, 'L');
            ...
            $this->Cell($ancho_linea, 6, date("d-m-Y", strtotime($this->datos[0]["DFECPRO"])), 'B', 1, 'L');
            $this->Ln(10);
