...
function recibo($pdf, $registro, $hoy, $usuario,$info)
{
    ...
    $pdf->CellFit($ancho_linea2 + 53, $tamanio_linea + 1, utf8_decode(mb_strtoupper($registro[0][2], 'utf-8')), 0, 0, 'L', 0, '', 1, 0);//name
    ...
    $pdf->Ln(3);
    $pdf->MultiCell($ancho_linea2+100, $tamanio_linea + 1, utf8_decode(mb_strtoupper($registro[0][5], 'utf-8')), 1, 'L');
