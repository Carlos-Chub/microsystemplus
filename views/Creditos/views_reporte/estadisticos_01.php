        ...
        <div class="row justify-items-md-center">
            <div class="col align-items-center">
                <button type="button" class="btn btn-outline-primary" title="Reporte en pdf"
                    onclick="reportes([[`ffin`],[`codofi`,`fondoid`],[`ragencia`,`rfondos`,`status`],[<?php echo $idusuario; ?>]],`pdf`,`clasificacion_frecpago`,0)">
                    <i class="fa-solid fa-file-pdf"></i> Pdf
                </button>
                <!-- <button type="button" class="btn btn-outline-success" title="Cartera en Excel"
                    onclick="reportes([[`ffin`],[`codofi`,`fondoid`],[`ragencia`,`rfondos`,`status`],[<?php echo $idusuario; ?>]],`xlsx`,`clasificacion_frecpago`,1)">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row justify-items-md-center">
                        <div class="col align-items-center">
                            <button type="button" class="btn btn-outline-primary" title="Reporte en pdf"
                                onclick="reportes([[`ffin`],[`codofi`,`fondoid`],[`ragencia`,`rfondos`,`status`],[<?php echo $idusuario; ?>]],`pdf`,`clasificacion_sector`,0)">
                                <i class="fa-solid fa-file-pdf"></i> Pdf
                            </button>
                            <!-- <button type="button" class="btn btn-outline-success" title="Cartera en Excel"
                                onclick="reportes([[`ffin`],[`codofi`,`fondoid`],[`ragencia`,`rfondos`,`status`],[<?php echo $idusuario; ?>]],`xlsx`,`clasificacion_sector`,1)">
                                <i class="fa-solid fa-file-excel"></i>Excel
                            </button> -->
                            <button type="button" class="btn btn-outline-danger" onclick="printdiv2('#cuadro','0')">
                                <i class="fa-solid fa-ban"></i> Cancelar
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row justify-items-md-center">
                        <div class="col align-items-center">
                            <button type="button" class="btn btn-outline-primary" title="Reporte en pdf"
                                onclick="reportes([[`ffin`],[`codofi`,`fondoid`],[`ragencia`,`rfondos`,`status`],[<?php echo $idusuario; ?>]],`pdf`,`clasificacion_rango_montos`,0)">
                                <i class="fa-solid fa-file-pdf"></i> Pdf
                            </button>
                            <!-- <button type="button" class="btn btn-outline-success" title="Cartera en Excel"
                                onclick="reportes([[`ffin`],[`codofi`,`fondoid`],[`ragencia`,`rfondos`,`status`],[<?php echo $idusuario; ?>]],`xlsx`,`clasificacion_sector`,1)">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row justify-items-md-center">
                                    <div class="col align-items-center">
                                        <button type="button" class="btn btn-outline-primary" title="Reporte en pdf"
                                            onclick="reportes([[`ffin`],[`codofi`,`fondoid`],[`ragencia`,`rfondos`,`status`],[<?php echo $idusuario; ?>]],`pdf`,`clasificacion_por_destino`,0)">
                                            <i class="fa-solid fa-file-pdf"></i> Pdf
                                        </button>
                                        <!-- <button type="button" class="btn btn-outline-success" title="Cartera en Excel"
                                            onclick="reportes([[`ffin`],[`codofi`,`fondoid`],[`ragencia`,`rfondos`,`status`],[<?php echo $idusuario; ?>]],`xlsx`,`clasificacion_sector`,1)">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row justify-items-md-center">
                                                <div class="col align-items-center">
                                                    <button type="button" class="btn btn-outline-primary" title="Reporte en pdf"
                                                        onclick="reportes([[`ffin`],[`codofi`,`fondoid`],[`ragencia`,`rfondos`,`status`],[<?php echo $idusuario; ?>]],`pdf`,`clasificacion_por_sexo`,0)">
                                                        <i class="fa-solid fa-file-pdf"></i> Pdf
                                                    </button>
                                                    <!-- <button type="button" class="btn btn-outline-success" title="Cartera en Excel"
                                                        onclick="reportes([[`ffin`],[`codofi`,`fondoid`],[`ragencia`,`rfondos`,`status`],[<?php echo $idusuario; ?>]],`xlsx`,`clasificacion_sector`,1)">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row justify-items-md-center">
                                                <div class="col align-items-center">
                                                    <button type="button" class="btn btn-outline-primary" title="Reporte en pdf"
                                                        onclick="reportes([[`ffin`],[`codofi`,`fondoid`],[`ragencia`,`rfondos`,`status`],[<?php echo $idusuario; ?>]],`pdf`,`clasificacion_por_ubicacion`,0)">
                                                        <i class="fa-solid fa-file-pdf"></i> Pdf
                                                    </button>
                                                    <!-- <button type="button" class="btn btn-outline-success" title="Cartera en Excel"
                                                        onclick="reportes([[`ffin`],[`codofi`,`fondoid`],[`ragencia`,`rfondos`,`status`],[<?php echo $idusuario; ?>]],`xlsx`,`clasificacion_sector`,1)">
