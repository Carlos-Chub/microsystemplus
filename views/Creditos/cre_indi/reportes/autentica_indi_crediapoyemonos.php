...
function printpdf($datos, $garantias, $clientefiador, $info, $conexion)
{
    ...
    $pdf->CellFit(0, $tamanio_linea, utf8_decode('Autentica:'), 0, 0, 'L', 0, '', 1, 0);
    $pdf->Ln(8);
    ...
    $pdf->SetFont('Times', '', 9);
    $pdf->CellFit(8, 5, ' ', 0, 0, 'L', 0, '', 1, 0);
    $pdf->CellFit(77, 5, '(Deudor) ' . mb_strtoupper(utf8_decode($datos[0]['nomcli'])), 0, 0, 'C', 0, '', 1, 0);
    $pdf->CellFit(20, 5, ' ', 0, 0, 'L', 0, '', 1, 0);
    $pdf->CellFit(77, 5, '(Fiador) ' . mb_strtoupper(utf8_decode($clientefiador[0]['nomcli'])), 0, 0, 'C', 0, '', 1, 0);
    $pdf->Ln(5);
