...
printpdf($conexion, $codusu, $usuCli, $codCu);

function printpdf($conexion, $codusu, $usuCli, $codCu)
{
    ...
    $pdf->CellFit(40, 7, 'TOTALES', 0, 0, 'R', 0, '', 1, 0);
    ...
    $pdf->CellFit(28, 7, 'Q ' . number_format($sumkp + $sumint + $sumotr, 2), 0, 0, 'R', 0, '', 1, 0);
    $pdf->CellFit(28, 7, 'Q ' . number_format($sumkp, 2), 0, 0, 'R', 0, '', 1, 0);
    $pdf->CellFit(28, 7, 'Q ' . number_format($sumint, 2), 0, 0, 'R', 0, '', 1, 0);
    $pdf->CellFit(28, 7, 'Q ' . number_format($sumotr, 2), 0, 0, 'R', 0, '', 1, 0);
