...
$strquery = "SELECT cl.idcod_cliente AS id, cl.idcod_cliente AS codcli, cl.no_identifica AS dpi, cl.no_tributaria AS nit, cl.short_name AS nombre, cl.date_birth AS fechacumple, cl.estado_civil AS civil,  
    ...
    (IFNULL((SELECT dep.nombre FROM clhpzzvb_bd_general_coopera.departamentos dep WHERE dep.codigo_departamento=cl.depa_reside),'-')) AS departamento, 
    (IFNULL((SELECT mun.nombre FROM clhpzzvb_bd_general_coopera.municipios mun WHERE mun.codigo_municipio=cl.muni_reside),'-')) AS municipio, 
    ...
    (IFNULL((SELECT dep2.nombre FROM tb_ingresos ing INNER JOIN clhpzzvb_bd_general_coopera.departamentos dep2 ON ing.depa_negocio=dep2.codigo_departamento WHERE ing.Tipo_ingreso=1 AND ing.id_cliente=cl.idcod_cliente LIMIT 1),'-')) AS depnegocio, 
    (IFNULL((SELECT mun2.nombre FROM tb_ingresos ing INNER JOIN clhpzzvb_bd_general_coopera.municipios mun2 ON ing.muni_negocio=mun2.codigo_municipio WHERE ing.Tipo_ingreso=1 AND ing.id_cliente=cl.idcod_cliente LIMIT 1),'-')) AS muninegocio,
    ...
    INNER JOIN clhpzzvb_bd_general_coopera.tb_sectoreseconomicos sect ON cm.CSecEco=sect.id_SectoresEconomicos
    INNER JOIN clhpzzvb_bd_general_coopera.tb_ActiEcono act ON cm.ActoEcono=act.id_ActiEcono
...
function printpdf($datos, $garantias, $info, $conexion)
{
    ...
    $pdf->Cell(0, $tamanio_linea, utf8_decode("FICHA DE ANÁLISIS DE CRÉDITO INDIVIDUAL"), 0, 1, 'C');
    ...
    $pdf->CellFit($ancho_linea + 30, $tamanio_linea, (($datos[0]['nombre'] == '' || $datos[0]['nombre'] == null) ? ' ' : utf8_decode($datos[0]['nombre'])), 0, 0, 'L', 0, '', 1, 0);
    $pdf->CellFit($ancho_linea - 20, $tamanio_linea, ' ', 0, 0, 'L', 0, '', 1, 0);
    $pdf->SetFont($fuente, 'B', 9);
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode('Dirección:'), 0, 0, 'L', 0, '', 1, 0);
    $pdf->SetFont($fuente, '', 9);
    $pdf->CellFit($ancho_linea + 30, $tamanio_linea, (($datos[0]['direccion'] == '' || $datos[0]['direccion'] == null) ? ' ' : utf8_decode($datos[0]['direccion'])), 0, 0, 'L', 0, '', 1, 0);
    $pdf->Ln(6);
    ...
    $pdf->SetFont($fuente, '', 9);
    $pdf->CellFit($ancho_linea + 30, $tamanio_linea, (($datos[0]['municipio'] == '' || $datos[0]['municipio'] == null) ? ' ' : utf8_decode($datos[0]['municipio'])), 0, 0, 'L', 0, '', 1, 0);
    $pdf->Ln(6);
    ...
    $pdf->SetFont($fuente, '', 9);
    $pdf->CellFit($ancho_linea + 30, $tamanio_linea, (($datos[0]['departamento'] == '' || $datos[0]['departamento'] == null) ? ' ' : utf8_decode($datos[0]['departamento'])), 0, 0, 'L', 0, '', 1, 0);
    $pdf->Ln(6);
    ...
    $pdf->SetFont($fuente, '', 9);
    $pdf->CellFit($ancho_linea + 30, $tamanio_linea, (($datos[0]['analista'] == '' || $datos[0]['analista'] == null) ? ' ' : utf8_decode($datos[0]['analista'])), 0, 0, 'L', 0, '', 1, 0);
    $pdf->Ln(6);
    ...
    $pdf->SetFont($fuente, '', 9);
    $pdf->CellFit($ancho_linea + 30, $tamanio_linea, (($datos[0]['civil'] == '' || $datos[0]['civil'] == null) ? ' ' : utf8_decode($datos[0]['civil'])), 0, 0, 'L', 0, '', 1, 0);
    $pdf->CellFit($ancho_linea - 20, $tamanio_linea, ' ', 0, 0, 'L', 0, '', 1, 0);
    $pdf->SetFont($fuente, 'B', 9);
    $pdf->CellFit($ancho_linea, $tamanio_linea, 'Dir. Negocio:', 0, 0, 'L', 0, '', 1, 0);
    $pdf->SetFont($fuente, '', 9);
    $pdf->CellFit($ancho_linea + 30, $tamanio_linea, (($datos[0]['direcnegocio'] == '' || $datos[0]['direcnegocio'] == null) ? ' ' : utf8_decode($datos[0]['direcnegocio'])), 0, 0, 'L', 0, '', 1, 0);
    $pdf->Ln(6);

    $pdf->SetFont($fuente, 'B', 9);
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode('Teléfono 1:'), 0, 0, 'L', 0, '', 1, 0);
    $pdf->SetFont($fuente, '', 9);
    $pdf->CellFit($ancho_linea + 30, $tamanio_linea, (($datos[0]['telcliente1'] == '' || $datos[0]['telcliente1'] == null) ? ' ' : ($datos[0]['telcliente1'])), 0, 0, 'L', 0, '', 1, 0);
    $pdf->CellFit($ancho_linea - 20, $tamanio_linea, ' ', 0, 0, 'L', 0, '', 1, 0);
    $pdf->SetFont($fuente, 'B', 9);
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode('Municipio:'), 0, 0, 'L', 0, '', 1, 0);
    $pdf->SetFont($fuente, '', 9);
    $pdf->CellFit($ancho_linea + 30, $tamanio_linea, (($datos[0]['muninegocio'] == '' || $datos[0]['muninegocio'] == null) ? ' ' : utf8_decode($datos[0]['muninegocio'])), 0, 0, 'L', 0, '', 1, 0);
    $pdf->Ln(6);

    $pdf->SetFont($fuente, 'B', 9);
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode('Teléfono 2:'), 0, 0, 'L', 0, '', 1, 0);
    $pdf->SetFont($fuente, '', 9);
    ...
    $pdf->CellFit($ancho_linea, $tamanio_linea, 'Departamento:', 0, 0, 'L', 0, '', 1, 0);
    $pdf->SetFont($fuente, '', 9);
    $pdf->CellFit($ancho_linea + 30, $tamanio_linea, (($datos[0]['depnegocio'] == '' || $datos[0]['depnegocio'] == null) ? ' ' : utf8_decode($datos[0]['depnegocio'])), 0, 0, 'L', 0, '', 1, 0);
    $pdf->Ln(6);

    $pdf->SetFont($fuente, 'B', 9);
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode('Profesión:'), 0, 0, 'L', 0, '', 1, 0);
    $pdf->SetFont($fuente, '', 9);
    $pdf->CellFit($ancho_linea + 30, $tamanio_linea, (($datos[0]['profesion'] == '' || $datos[0]['profesion'] == null) ? ' ' : utf8_decode($datos[0]['profesion'])), 0, 0, 'L', 0, '', 1, 0);
    $pdf->Ln(6);

    //SECCION DE CREDITO SOLICITADO
    $pdf->Cell(0, $tamanio_linea, ' ', 'B', 1, 'C');
    $pdf->SetFont($fuente, 'B', 9);
    $pdf->Cell(0, $tamanio_linea, utf8_decode("DATOS DEL CRÉDITO EN ESTADO DE ANÁLISIS"), 0, 0, 'C');
    $pdf->Ln(6);

    $pdf->SetFont($fuente, 'B', 9);
    $pdf->CellFit($ancho_linea + 25, $tamanio_linea, ' ', 0, 0, 'L', 0, '', 1, 0);
    $pdf->CellFit($ancho_linea + 10, $tamanio_linea, utf8_decode('Código crédito:'), 0, 0, 'R', 0, '', 1, 0);
    $pdf->SetFont($fuente, '', 9);
    ...
    $pdf->SetFont($fuente, '', 9);
    $pdf->CellFit(0, $tamanio_linea, utf8_decode('DATOS DEL PRODUCTO'), 'B', 0, 'L', 0, '', 1, 0);
    $pdf->Ln(6);
    ...
    $pdf->CellFit($ancho_linea, $tamanio_linea, 'Nombre:', 0, 0, 'L', 0, '', 1, 0);
    $pdf->SetFont($fuente, '', 9);
    $pdf->CellFit($ancho_linea + 30, $tamanio_linea, (($datos[0]['nomprod'] == '' || $datos[0]['nomprod'] == null) ? ' ' : utf8_decode($datos[0]['nomprod'])), 0, 0, 'L', 0, '', 1, 0);
    $pdf->Ln(6);

    $pdf->SetFont($fuente, 'B', 9);
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode('Descripción:'), 0, 0, 'L', 0, '', 1, 0);
    $pdf->SetFont($fuente, '', 9);
    $pdf->CellFit($ancho_linea + 30, $tamanio_linea, (($datos[0]['descprod'] == '' || $datos[0]['descprod'] == null) ? ' ' : utf8_decode($datos[0]['descprod'])), 0, 0, 'L', 0, '', 1, 0);
    $pdf->CellFit($ancho_linea - 20, $tamanio_linea, ' ', 0, 0, 'L', 0, '', 1, 0);
    $pdf->SetFont($fuente, 'B', 9);
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode('Interés anual:'), 0, 0, 'L', 0, '', 1, 0);
    $pdf->SetFont($fuente, '', 9);
    $pdf->CellFit($ancho_linea + 30, $tamanio_linea, (($datos[0]['intprod'] == '' || $datos[0]['intprod'] == null) ? ' ' : utf8_decode($datos[0]['intprod']) . '%'), 0, 0, 'L', 0, '', 1, 0);
    $pdf->Ln(6);

    $pdf->SetFont($fuente, 'B', 9);
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode('Mon. Máximo:'), 0, 0, 'L', 0, '', 1, 0);
    $pdf->SetFont($fuente, '', 9);
    $pdf->CellFit($ancho_linea + 30, $tamanio_linea, (($datos[0]['monprod'] == '' || $datos[0]['monprod'] == null) ? ' ' : utf8_decode(number_format($datos[0]['monprod'], 2, '.', ','))), 0, 0, 'L', 0, '', 1, 0);
    $pdf->CellFit($ancho_linea - 20, $tamanio_linea, ' ', 0, 0, 'L', 0, '', 1, 0);
    $pdf->SetFont($fuente, 'B', 9);
    $pdf->CellFit($ancho_linea, $tamanio_linea, 'Fuente Fondo:', 0, 0, 'L', 0, '', 1, 0);
    $pdf->SetFont($fuente, '', 9);
    $pdf->CellFit($ancho_linea + 30, $tamanio_linea, (($datos[0]['fondoprod'] == '' || $datos[0]['fondoprod'] == null) ? ' ' : utf8_decode($datos[0]['fondoprod'])), 0, 0, 'L', 0, '', 1, 0);
    $pdf->Ln(8);

    $pdf->SetFont($fuente, '', 9);
    $pdf->CellFit(0, $tamanio_linea, utf8_decode('DATOS COMPLEMENTARIOS'), 'B', 0, 'L', 0, '', 1, 0);
    $pdf->Ln(6);
    ...
    $pdf->SetFont($fuente, 'B', 9);
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode('Tip. Crédito:'), 0, 0, 'L', 0, '', 1, 0);
    $pdf->SetFont($fuente, '', 9);
    $pdf->CellFit($ancho_linea + 30, $tamanio_linea, (($datos[0]['tipcredito'] == '' || $datos[0]['tipcredito'] == null) ? ' ' : utf8_decode($datos[0]['tipcredito'])), 0, 0, 'L', 0, '', 1, 0);
    $pdf->CellFit($ancho_linea - 20, $tamanio_linea, ' ', 0, 0, 'L', 0, '', 1, 0);
    $pdf->SetFont($fuente, 'B', 9);
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode('Tip. Perido:'), 0, 0, 'L', 0, '', 1, 0);
    $pdf->SetFont($fuente, '', 9);
    $pdf->CellFit($ancho_linea + 30, $tamanio_linea, (($datos[0]['tipperiodo'] == '' || $datos[0]['tipperiodo'] == null) ? ' ' : utf8_decode($datos[0]['tipperiodo'])), 0, 0, 'L', 0, '', 1, 0);
    $pdf->Ln(6);
    ...
    $pdf->SetFont($fuente, '', 9);
    $pdf->CellFit($ancho_linea + 30, $tamanio_linea, (($datos[0]['dictamen'] == '' || $datos[0]['dictamen'] == null) ? ' ' : utf8_decode($datos[0]['dictamen'])), 0, 0, 'L', 0, '', 1, 0);
    $pdf->Ln(6);
    ...
    $pdf->SetFont($fuente, '', 9);
    $pdf->CellFit($ancho_linea + 30, $tamanio_linea, (($datos[0]['destinocred'] == '' || $datos[0]['destinocred'] == null) ? ' ' : utf8_decode($datos[0]['destinocred'])), 0, 0, 'L', 0, '', 1, 0);
    $pdf->Ln(6);

    $pdf->SetFont($fuente, 'B', 9);
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode('Sector Económico:'), 0, 0, 'L', 0, '', 1, 0);
    $pdf->SetFont($fuente, '', 9);
    $pdf->CellFit($ancho_linea + 30, $tamanio_linea, (($datos[0]['sececonomico'] == '' || $datos[0]['sececonomico'] == null) ? ' ' : utf8_decode($datos[0]['sececonomico'])), 0, 0, 'L', 0, '', 1, 0);
    $pdf->CellFit($ancho_linea - 20, $tamanio_linea, ' ', 0, 0, 'L', 0, '', 1, 0);
    $pdf->SetFont($fuente, 'B', 9);
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode('Act. Económica:'), 0, 0, 'L', 0, '', 1, 0);
    $pdf->SetFont($fuente, '', 9);
    $pdf->CellFit($ancho_linea + 30, $tamanio_linea, (($datos[0]['acteconomico'] == '' || $datos[0]['acteconomico'] == null) ? ' ' : utf8_decode($datos[0]['acteconomico'])), 0, 0, 'L', 0, '', 1, 0);
    $pdf->Ln(6);

    $pdf->SetFont($fuente, 'B', 9);
    $pdf->CellFit($ancho_linea, $tamanio_linea, ('Estado:'), 0, 0, 'L', 0, '', 1, 0);
    $pdf->SetFont($fuente, '', 9);
    $pdf->CellFit($ancho_linea + 30, $tamanio_linea, (($datos[0]['estado'] == '' || $datos[0]['estado'] == null) ? ' ' : utf8_decode($datos[0]['estado'])), 0, 0, 'L', 0, '', 1, 0);
    $pdf->CellFit($ancho_linea - 20, $tamanio_linea, ' ', 0, 0, 'L', 0, '', 1, 0);
    $pdf->SetFont($fuente, 'B', 9);
    ...
    $pdf->SetFont($fuente, 'B', 9);
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode('Fec. Análisis:'), 0, 0, 'L', 0, '', 1, 0);
    $pdf->SetFont($fuente, '', 9);
    ...
    //GARANTIAS
    $pdf->SetFont($fuente, '', 9);
    $pdf->CellFit(0, $tamanio_linea, utf8_decode('GARANTIAS DEL CRÉDITO'), 'B', 0, 'L', 0, '', 1, 0);
    $pdf->Ln(6);

    //ENCABEZADO
    $pdf->SetFont($fuente, 'B', 8);
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode('Tip. Garantia'), 'B', 0, 'C', 0, '', 1, 0);
    $pdf->CellFit($ancho_linea + 5, $tamanio_linea, utf8_decode('Tip. Documento'), 'B', 0, 'C', 0, '', 1, 0);
    $pdf->CellFit($ancho_linea + 30, $tamanio_linea, utf8_decode('Descripción'), 'B', 0, 'C', 0, '', 1, 0);
    $pdf->CellFit($ancho_linea + 10, $tamanio_linea, utf8_decode('Dirección'), 'B', 0, 'C', 0, '', 1, 0);
    $pdf->CellFit($ancho_linea - 5, $tamanio_linea, utf8_decode('Mon. Gravamen'), 'B', 0, 'C', 0, '', 1, 0);
    $pdf->Ln(6);
    ...
    for ($i = 0; $i < count($garantias); $i++) {
        ...
        //tipo documento
        $pdf->MultiCell($ancho_linea + 5, $tamanio_linea, (($garantias[$i]['nomtipdoc'] == '' || $garantias[$i]['nomtipdoc'] == null) ? ' ' : utf8_decode($garantias[$i]['nomtipdoc'])), 0, 'L', $resaltado);
        $x = $x + ($ancho_linea + 5);
        $yaux = $pdf->GetY();
        ...
        if ($garantias[$i]["idtipgar"] == 1 && $garantias[$i]["idtipdoc"] == 1) {
            ...
            $pdf->MultiCell($ancho_linea + 30, $tamanio_linea, (($garantias[$i]['nomcli'] == '' || $garantias[$i]['nomcli'] == null) ? ' ' : utf8_decode($garantias[$i]['nomcli'])), 0, 'L', $resaltado);
            $x = $x + ($ancho_linea + 30);
            $yaux = $pdf->GetY();
            ...
            $pdf->MultiCell($ancho_linea + 10, $tamanio_linea, (($garantias[$i]['direccioncli'] == '' || $garantias[$i]['direccioncli'] == null) ? ' ' : utf8_decode($garantias[$i]['direccioncli'])), 0, 'L', $resaltado);
            $x = $x + ($ancho_linea + 10);
            $yaux = $pdf->GetY();
            ...
            $pdf->MultiCell($ancho_linea + 30, $tamanio_linea, (($garantias[$i]['descripcion'] == '' || $garantias[$i]['descripcion'] == null) ? ' ' : utf8_decode($garantias[$i]['descripcion'])), 0, 'L', $resaltado);
            $x = $x + ($ancho_linea + 30);
            $yaux = $pdf->GetY();
            ...
            $x = $pdf->GetX();
            //direccion cuando
            $pdf->MultiCell($ancho_linea + 10, $tamanio_linea, (($garantias[$i]['direccion'] == '' || $garantias[$i]['direccion'] == null) ? ' ' : utf8_decode($garantias[$i]['direccion'])), 0, 'L', $resaltado);
            $x = $x + ($ancho_linea + 10);
            $yaux = $pdf->GetY();
    ...
    $pdf->CellFit($ancho_linea + 23, $tamanio_linea, ' ', 0, 0, 'L', 0, '', 1, 0);
    $pdf->SetFont($fuente, 'B', 9);
    $pdf->CellFit($ancho_linea + 55, $tamanio_linea, (($datos[0]['analista'] == '' || $datos[0]['analista'] == null) ? ' ' : strtoupper(utf8_decode($datos[0]['analista']))), 0, 0, 'C', 0, '', 1, 0);
    $pdf->SetFont($fuente, 'B', 9);
    $pdf->CellFit($ancho_linea + 22, $tamanio_linea, ' ', 0, 0, 'L', 0, '', 1, 0);
    $pdf->SetFont($fuente, 'B', 9);
    $pdf->Ln(6);
