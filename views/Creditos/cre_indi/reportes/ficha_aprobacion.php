...
function printpdf($datos, $garantias, $info, $conexion)
{
    ...
    $pdf->Cell(0, $tamanio_linea, utf8_decode("FICHA DE APROBACIÓN DE CRÉDITO INDIVIDUAL"), 0, 1, 'C');
    ...
    $pdf->Cell(0, $tamanio_linea, ' ', 'B', 1, 'C');
    $pdf->SetFont($fuente, 'B', 9);
    $pdf->Cell(0, $tamanio_linea, utf8_decode("DATOS DEL CRÉDITO EN ESTADO DE APROBADO"), 0, 0, 'C');
    $pdf->Ln(6);
    ...
    $pdf->CellFit($ancho_linea - 20, $tamanio_linea, ' ', 0, 0, 'L', 0, '', 1, 0);
    $pdf->SetFont($fuente, 'B', 9);
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode('Fec. Aprobación:'), 0, 0, 'L', 0, '', 1, 0);
    $pdf->SetFont($fuente, '', 9);
