      ...
      <div class="card crdbody">
        ...
        <div class="card-body">
          ...
          <div class="row crdbody col-sm-2">
            ...
            <button type="button" onclick="opciones(1)" class="btn btn-outline-primary" title="Buscar Grupo" data-bs-toggle="modal" data-bs-target="#buscargrupo">
            ...
            <div class="row crdbody">
              ...
              <div class="col-md-5">
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" id="canton" placeholder="Canton, Aldea, Colonia, etc.">
                </div>
              </div>
              ...
              <div class="col-md-7">
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" id="direcciongrupo" placeholder="14 av 2-14 z4" required>
                </div>
              </div>
            </div> <!-- <div class="row crdbody"> _-->
          ...
          <div class="row">
            <div class=" col-sm-6">
              <button id="btnGua" class="btn btn-outline-success" type="submit" onclick="insttbl('<?= $codusu ?>');">
                <i class="fa-solid fa-floppy-disk"></i> Guardar</button>

              <button id="btnAct" class="btn btn-outline-primary" type="submit" onclick="insttbl('<?= $codusu ?>');">
    ...
    <div class="container">
      <div class="card crdbody">
        ...
        <div class="card-body">
          ...
          <div class="row" >
            <div class="col-lg-12 col-md-12 col-sm-12" id="msjAlerta">
              ...
              <div class="alert alert-warning d-flex align-items-center" role="alert">
                ...
                <div>
                  El grupo seleccionado se encuentra en un ciclo crediticio, razón por la cual no puede ser modificado.
                </div>
              </div>
            </div>
          ...
          <button type="button" id="ingresarCliente" class="btn btn-outline-info" title="Adicionar Integrante" onclick="addclntgrp()">
            <i class="fa-solid fa-circle-plus fa-xl"></i></button>

          <button type="button" class="btn btn-outline-info" title="Imprimir" onclick="printreportgroup()" data-target="_blank">
      ...
      <div class="card crdbody">
        ...
        <div class="card-body">
          <div class="row col-sm-2 crdbody">
            <button type="button" class="btn btn-outline-primary" title="Buscar Grupo" data-bs-toggle="modal" data-bs-target="#buscargrupo">
              <i class="fa-solid fa-magnifying-glass"></i> Buscar Grupo </button>
          </div>
