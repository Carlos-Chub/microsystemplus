...
function printpdf($datos, $info, $id_usu, $conexion)
{
    ...
    class PDF extends FPDF
    {
        ...
        function Header()
        {
            ...
            while ($res = mysqli_fetch_array($data_usu, MYSQLI_ASSOC)) {
                $codusu = strtoupper(utf8_decode($res["usu"]));
            }
    ...
    $pdf->CellFit($ancho_linea+10, $tamanio_linea, utf8_decode('Nombre del Cliente:'), 0, 0, 'C', 0, '', 1, 0);
    $pdf->SetFont($fuente, '', 11);
    $pdf->CellFit(50, $tamanio_linea, utf8_decode((($datos[0]['nombre'] == '' || $datos[0]['nombre'] == null) ? ' ' : $datos[0]['nombre'])), 0, 0, 'C', 0, '', 1, 0);
    $pdf->SetFont($fuente, 'B', 11);
    $pdf->CellFit($ancho_linea+10, $tamanio_linea, utf8_decode('Codigo de Cliente:'), 0, 0, 'C', 0, '', 1, 0);
    $pdf->SetFont($fuente, '', 11);
    $pdf->CellFit(50, $tamanio_linea, utf8_decode((($datos[0]['codcli'] == '' || $datos[0]['codcli'] == null) ? ' ' : $datos[0]['codcli'])), 0, 0, 'L', 0, '', 1, 0);
    $pdf->Ln(6);
    $pdf->SetFont($fuente, 'B', 11);
    $pdf->CellFit($ancho_linea+10, $tamanio_linea, utf8_decode('DPI:'), 0, 0, 'L', 0, '', 1, 0);
    $pdf->SetFont($fuente, '', 11);
    $pdf->CellFit(50, $tamanio_linea, utf8_decode(utf8_decode((($datos[0]['dpi'] == '' || $datos[0]['dpi'] == null) ? ' ' : $datos[0]['dpi']))), 0, 0, 'L', 0, '', 1, 0);
    $pdf->SetFont($fuente, 'B', 11);
    $pdf->CellFit($ancho_linea+10, $tamanio_linea, utf8_decode('Direccion:'), 0, 0, 'L', 0, '', 1, 0);
    $pdf->SetFont($fuente, '', 11);
    $pdf->CellFit(50, $tamanio_linea, utf8_decode((($datos[0]['direccion'] == '' || $datos[0]['direccion'] == null) ? ' ' : $datos[0]['direccion'])), 0, 0, 'L', 0, '', 1, 0);
    $pdf->Ln(6);
    $pdf->SetFont($fuente, 'B', 11);
    $pdf->CellFit($ancho_linea+10, $tamanio_linea, utf8_decode('Fecha de Nacimiento:'), 0, 0, 'L', 0, '', 1, 0);
    $pdf->SetFont($fuente, '', 11);
    $pdf->CellFit(50, $tamanio_linea, utf8_decode((($datos[0]['fechacumple'] == '' || $datos[0]['fechacumple'] == null) ? ' ' : $datos[0]['fechacumple'])), 0, 0, 'L', 0, '', 1, 0);
    $pdf->SetFont($fuente, 'B', 11);
    $pdf->CellFit($ancho_linea+10, $tamanio_linea, utf8_decode('Telefono:'), 0, 0, 'L', 0, '', 1, 0);
    $pdf->SetFont($fuente, '', 11);
    $pdf->CellFit(50, $tamanio_linea, utf8_decode((($datos[0]['telefono'] == '' || $datos[0]['telefono'] == null) ? ' ' : $datos[0]['telefono'])), 0, 0, 'L', 0, '', 1, 0);
    $pdf->Ln(6);
    $pdf->SetFont($fuente, 'B', 11);
    $pdf->CellFit($ancho_linea+10, $tamanio_linea, utf8_decode('Genero:'), 0, 0, 'L', 0, '', 1, 0);
    $pdf->SetFont($fuente, '', 11);
    $pdf->CellFit(50, $tamanio_linea, utf8_decode((($datos[0]['genero'] == '' || $datos[0]['genero'] == null) ? ' ' : $datos[0]['genero'])), 0, 0, 'L', 0, '', 1, 0);
    $pdf->Ln(6);
    $pdf->SetFont($fuente, 'b', 10);
    $pdf->CellFit(0, $tamanio_linea, utf8_decode('__________________________________________________________________________________'), 0, 0, 'C', 0, '', 1, 0);
    $pdf->Ln(12);

    //fecha de evaluacion 
    $pdf->SetFont($fuente, '', 10);
    $pdf->CellFit(0, $tamanio_linea, utf8_decode('FECHA DE EVALUACION DE BALANCE:'), 0, 0, 'C', 0, '', 1, 0);
    $pdf->Ln(12);

    //FECHA DE EVALUACION
    $pdf->SetFont($fuente, '', 9);
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode('Fecha de eval. :'), 0, 0, 'L', 0, '', 1, 0);
    $pdf->SetFont($fuente, '', 9);
    ...
    //FECHA DE BALANCE
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode('Fecha de Balance:'), 0, 0, 'L', 0, '', 1, 0);
    ...
    $pdf->CellFit(90, $tamanio_linea, utf8_decode(' '), 0, 0, 'C', 0, '', 1, 0);
    ...
    $pdf->Ln(12);
    $pdf->SetFont($fuente, '', 10);
    $pdf->CellFit(0, $tamanio_linea, utf8_decode('INGRESO, EGRESO, SALDO:'), 0, 0, 'C', 0, '', 1, 0);
    $pdf->Ln(12);

    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode('   '), 0, 0, 'L', 0, '', 1, 0);
    //vacio
    $pdf->CellFit($ancho_linea-10, $tamanio_linea, utf8_decode('   '), 0, 0, 'L', 0, '', 1, 0);
    //

    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode('Sub Sub Cuentas'), 0, 0, 'L', 0, '', 1, 0);
    $pdf->CellFit(7, $tamanio_linea, utf8_decode(' '), 0, 0, 'L', 0, '', 1, 0);
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode('Sub Cuentas'), 0, 0, 'L', 0, '', 1, 0);
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode('Cuentas'), 0, 0, 'L', 0, '', 1, 0);

    $pdf->Ln(12);
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode('Activo  circulante'), 0, 0, 'L', 0, '', 1, 0);
    ...
    //Disponible
    $pdf->SetFont($fuente, '', 9);
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode('Disponible'), 0, 0, 'L', 0, '', 1, 0);
    //columna 0
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode('  '), 0, 0, 'L', 0, '', 1, 0);
    //columna 1
    ...
    //Cuentas por cobrar
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode('Cuentas por cobrar'), 0, 0, 'L', 0, '', 1, 0);
    //columna 0
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode(' '), 0, 0, 'L', 0, '', 1, 0);
    //columna 1
    $pdf->SetFont($fuente, '', 9);
    ...
    $pdf->Ln(6);
    //Cuentas por cobrar
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode('Otras cuentas por Cob.'), 0, 0, 'L', 0, '', 1, 0);
    ...
    //Invetario
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode('Inventario'), 0, 0, 'L', 0, '', 1, 0);
    //columna 0
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode('  '), 0, 0, 'L', 0, '', 1, 0);
    //columna 1
    ...
    //Activo Fijo
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode('Activo Fijo'), 0, 0, 'L', 0, '', 1, 0);
    //columna 0
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode('  '), 0, 0, 'L', 0, '', 1, 0);
    //columna 1
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode('  '), 0, 0, 'L', 0, '', 1, 0);
    ...
    //Total activo 
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode('Total activo'), 0, 0, 'L', 0, '', 1, 0);
    //columna 0
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode(' '), 0, 0, 'L', 0, '', 1, 0);
    //columna 1
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode(' '), 0, 0, 'L', 0, '', 1, 0);
    ...
    //PAsivo
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode('Pasivo '), 0, 0, 'L', 0, '', 1, 0);
    //columna 0
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode(' '), 0, 0, 'L', 0, '', 1, 0);
    //columna 1
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode(' '), 0, 0, 'L', 0, '', 1, 0);
    ...
    //Proveedores
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode('Proveedores '), 0, 0, 'L', 0, '', 1, 0);
    //columna 0
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode(' '), 0, 0, 'L', 0, '', 1, 0);
    //columna 1
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode(' '), 0, 0, 'L', 0, '', 1, 0);
    ...
    $pdf->Ln(6);
    //Otros prestamos 
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode('Otros prestamos '), 0, 0, 'L', 0, '', 1, 0);
    //columna 0
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode(' '), 0, 0, 'L', 0, '', 1, 0);
    //columna 1
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode('  '), 0, 0, 'L', 0, '', 1, 0);
    ...
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode('Prestamos Inst. '), 0, 0, 'L', 0, '', 1, 0);
    //columna 0
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode(' '), 0, 0, 'L', 0, '', 1, 0);
    //columna 1
    ...
    //Patrimonio
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode('Patrimonio '), 0, 0, 'L', 0, '', 1, 0);
    //columna 0
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode(' '), 0, 0, 'L', 0, '', 1, 0);
    //columna 1
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode(' '), 0, 0, 'L', 0, '', 1, 0);
    ...
    //
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode('Ingresos '), 0, 0, 'L', 0, '', 1, 0);
    //columna 0
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode(' '), 0, 0, 'L', 0, '', 1, 0);
    //columna 1
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode(' '), 0, 0, 'L', 0, '', 1, 0);
    ...
    $pdf->Ln(6);
    //
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode('Ingresos Famil.'), 0, 0, 'L', 0, '', 1, 0);
    //columna 0
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode(' '), 0, 0, 'L', 0, '', 1, 0);
    //columna 1
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode(' '), 0, 0, 'L', 0, '', 1, 0);
    ...
    //VENTAS
    $pdf->SetFont($fuente, '', 9);
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode('Ventas'), 0, 0, 'L', 0, '', 1, 0);
    //columna 0
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode(' '), 0, 0, 'L', 0, '', 1, 0);
    //columna 1
    $pdf->SetFont($fuente, '', 9);
    ...
    //
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode('Negocio'), 0, 0, 'L', 0, '', 1, 0);
    //columna 0
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode(' '), 0, 0, 'L', 0, '', 1, 0);
    //columna 1
    ...
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode('Egresos'), 0, 0, 'L', 0, '', 1, 0);
    //columna 0
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode(' '), 0, 0, 'L', 0, '', 1, 0);
    //columna 1
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode(' '), 0, 0, 'L', 0, '', 1, 0);
    ...
    $pdf->Ln(6);
    //
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode('Compra de Merc.'), 0, 0, 'L', 0, '', 1, 0);
    //columna 0
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode(' '), 0, 0, 'L', 0, '', 1, 0);
    //columna 1
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode(' '), 0, 0, 'L', 0, '', 1, 0);
    ...
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode('Pago de prest.'), 0, 0, 'L', 0, '', 1, 0);
    //columna 0
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode(' '), 0, 0, 'L', 0, '', 1, 0);
    //columna 1
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode(' '), 0, 0, 'L', 0, '', 1, 0);
    ...
    $pdf->Ln(12);
    $pdf->SetFont($fuente, 'B', 10);
    $pdf->CellFit(0, $tamanio_linea, utf8_decode('____________________________________________________________________________________________'), 0, 0, 'C', 0, '', 1, 0);
    $pdf->Ln(12);
    $pdf->SetFont($fuente, '', 10);
    //
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode('Balance'), 0, 0, 'L', 0, '', 1, 0);
    //columna 0
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode(' '), 0, 0, 'L', 0, '', 1, 0);
    //columna 1
    $pdf->CellFit($ancho_linea, $tamanio_linea, utf8_decode(' '), 0, 0, 'L', 0, '', 1, 0);
