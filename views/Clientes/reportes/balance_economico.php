...
function printpdf($registro, $info, $id_usu, $conexion)
{
    ...
    $pdf->CellFit(0, $tamanio_linea + 1, utf8_decode('INFORMACIÓN FINANCIERA'), 0, 0, 'C', 0, '', 1, 0);
    $pdf->Ln(10);

    $pdf->SetFont($fuente, '', 9);
    $pdf->MultiCell(0, $tamanio_linea + 1, utf8_decode('Con el propósito de solicitar un crédito, someto a consideración la siguiente información financiera referida a la fecha indicada en el epigrafe, compromentiendome a NO hacer ningún cambio material que disminuya el capital neto'), 0, 'J');
    $pdf->Ln(6);
    ...
    $pdf->CellFit($ancho_linea2 - 19, $tamanio_linea + 1, ' ', 0, 0, 'C', 0, '', 1, 0);
    $pdf->CellFit($ancho_linea2 + 20, $tamanio_linea + 1, utf8_decode('Otros préstamos'), 0, 0, 'L', 0, '', 1, 0);
    $pdf->CellFit($ancho_linea2 - 25, $tamanio_linea + 1, ' ', 0, 0, 'C', 0, '', 1, 0);
    ...
    $pdf->CellFit($ancho_linea2 - 19, $tamanio_linea + 1, ' ', 0, 0, 'C', 0, '', 1, 0);
    $pdf->CellFit($ancho_linea2 + 20, $tamanio_linea + 1, utf8_decode('Préstamos a instituciones'), 0, 0, 'L', 0, '', 1, 0);
    $pdf->CellFit($ancho_linea2 - 25, $tamanio_linea + 1, ' ', 0, 0, 'C', 0, '', 1, 0);
    ...
    // quinta linea
    $pdf->SetFont($fuente, '', 9);
    $pdf->CellFit($ancho_linea2 + 45, $tamanio_linea + 1, utf8_decode('Compra de mercadería'), 0, 0, 'L', 0, '', 1, 0);
    $pdf->CellFit($ancho_linea2 - 25, $tamanio_linea + 1, ' ', 0, 0, 'C', 0, '', 1, 0);
    ...
    // septima linea
    $pdf->SetFont($fuente, '', 9);
    $pdf->CellFit($ancho_linea2 + 45, $tamanio_linea + 1, utf8_decode('Pagos de créditos'), 0, 0, 'L', 0, '', 1, 0);
    $pdf->CellFit($ancho_linea2 - 25, $tamanio_linea + 1, ' ', 0, 0, 'C', 0, '', 1, 0);
