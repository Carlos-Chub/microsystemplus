...
?>
                            ...
                            <div class="card-body">
                                <div class="row mb-3">
                                    <div class=" col-sm-3">
                                        ...
                                        <input type="date" class="form-control" id="alta_inicio" min="1950-01-01" value="<?php echo date("Y-m-d"); ?>">
                                    </div>
                                    <div class=" col-sm-3">
                                        <label for="alta_fin">Hasta</label>
                                        <input type="date" class="form-control" id="alta_fin" min="1950-01-01" value="<?php echo date("Y-m-d"); ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="row mb-3">
                                    <div class=" col-sm-3">
                                        ...
                                        <input type="date" class="form-control" id="baja_inicio" min="1950-01-01" value="<?php echo date("Y-m-d"); ?>">
                                    </div>
                                    <div class=" col-sm-3">
                                        <label for="date_inicio">Hasta</label>
                                        <input type="date" class="form-control" id="baja_fin" min="1950-01-01" value="<?php echo date("Y-m-d"); ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <button type="button" class="btn btn-success btn-lg" onclick="printxls()">
    ...
    case 'balance_economico': {
            ...
            if ($xtra != 0) {
                $consulta = mysqli_query($conexion, "SELECT cl.idcod_cliente AS codcli, cl.short_name AS nombre, cl.no_identifica AS dpi, cl.Direccion AS direccion, cl.date_birth AS fechacumple,  cl.tel_no1 AS telefono, cl.genero AS genero, cl.id_tb_cli_balance AS id_balance
                ...
                <div class="card-body" style="padding-bottom: 0px !important;">
                    ...
                    <div class="container contenedort" style="max-width: 100% !important;">
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-6">
                                <div class="form-floating mb-3 mt-2">
                                    <input type="date" class="form-control" id="fecevaluacion" placeholder="Fecha de evaluación" <?php echo 'value="' . date("Y-m-d") . '"'; ?>>
                                    <label for="fecevaluacion">Fecha de evaluación</label>
                                </div>
                            </div>
                            <div class="col-12 col-sm-6">
                                <div class="form-floating mb-3 mt-2">
                                    <input type="date" class="form-control" id="fecbalance" placeholder="Fecha de balance" <?php echo 'value="' . date("Y-m-d") . '" readonly disabled'; ?>>
                        ...
                        <div class="row m-1">
                            <div class="col-12 col-sm-6 col-md-4 mb-2 border border-primary">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="text-center mb-2"><span class="badge text-bg-primary" id="ingresostotal">Q. 0.00</span></div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-floating mb-1 mt-1">
                                            <input type="number" step="0.01" class="form-control" onkeyup="sumar_valores_inputs('#ingresostotal',['#ventas','#cporcobrar'],[],1); sumar_valores_inputs('#saldo',['#ventas','#cporcobrar'],['#mercaderia','#gastosporcobrar','#pagoscreditos'],2);" id="ventas" placeholder="Ventas">
                                            <label for="ventas">Ventas</label>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-floating mb-2 mt-1">
                                            <input type="number" step="0.01" class="form-control" onkeyup="sumar_valores_inputs('#ingresostotal',['#ventas','#cporcobrar'],[],1); sumar_valores_inputs('#saldo',['#ventas','#cporcobrar'],['#mercaderia','#gastosporcobrar','#pagoscreditos'],2);" id="cporcobrar" placeholder="Recup. cuentas por cobrar">
                            ...
                            <div class="col-12 col-sm-6 col-md-4 mb-2 border border-primary">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="text-center mb-2"><span class="badge text-bg-primary" id="egresostotal">Q. 0.00</span></div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-floating mb-1 mt-1">
                                            <input type="number" step="0.01" class="form-control" onkeyup="sumar_valores_inputs('#egresostotal',['#mercaderia','#gastosporcobrar','#pagoscreditos'],[],1); sumar_valores_inputs('#saldo',['#ventas','#cporcobrar'],['#mercaderia','#gastosporcobrar','#pagoscreditos'],2);" id="mercaderia" placeholder="Compra de mercadería">
                                            <label for="mercaderia">Compra de mercadería</label>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-floating mb-1 mt-1">
                                            <input type="number" step="0.01" class="form-control" onkeyup="sumar_valores_inputs('#egresostotal',['#mercaderia','#gastosporcobrar','#pagoscreditos'],[],1); sumar_valores_inputs('#saldo',['#ventas','#cporcobrar'],['#mercaderia','#gastosporcobrar','#pagoscreditos'],2);" id="gastosporcobrar" placeholder="Gastos del negocio">
                                            <label for="gastosporcobrar">Gastos del negocio</label>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-floating mb-2 mt-1">
                                            <input type="number" step="0.01" class="form-control" onkeyup="sumar_valores_inputs('#egresostotal',['#mercaderia','#gastosporcobrar','#pagoscreditos'],[],1); sumar_valores_inputs('#saldo',['#ventas','#cporcobrar'],['#mercaderia','#gastosporcobrar','#pagoscreditos'],2);" id="pagoscreditos" placeholder="Pagos de créditos">
                            ...
                            <div class="col-12 col-sm-12 col-md-4 mb-2 border border-primary">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-floating mb-2 mt-2">
                                            <input type="text" class="form-control" id="saldo" placeholder="Saldo disponible" readonly disabled>
                        ...
                        <div class="row m-1">
                            <div class="col-12 col-sm-6 col-md-4 mb-2 border border-primary">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="text-center mb-2"><span class="badge text-bg-primary" id="activototal">Q. 0.00</span></div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-floating mb-1 mt-1">
                                            <input type="number" step="0.01" class="form-control" id="actcirculante" placeholder="Activo circulante" readonly disabled>
                                            <label for="actcirculante">Activo circulante</label>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-floating mb-1 mt-1">
                                            <input type="number" step="0.01" class="form-control" id="disponible" onkeyup="sumar_valores_inputs('#actcirculante',['#disponible','#cuentascobrar','#inventario'],[],2); sumar_valores_inputs('#activototal',['#actcirculante','#activofijo'],[],1); sumar_valores_inputs('#saldo2',['#actcirculante','#activofijo'],['#pasivo'],2); sumar_valores_inputs('#patrimonio',['#actcirculante','#activofijo'],['#pasivo'],2); sumar_valores_inputs('#pasivototal',['#pasivo','#patrimonio'],[],1);" placeholder="Disponible">
                                            <label for="disponible">Disponible</label>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-floating mb-1 mt-1">
                                            <input type="number" step="0.01" class="form-control" id="cuentascobrar" onkeyup="sumar_valores_inputs('#actcirculante',['#disponible','#cuentascobrar','#inventario'],[],2); sumar_valores_inputs('#activototal',['#actcirculante','#activofijo'],[],1); sumar_valores_inputs('#saldo2',['#actcirculante','#activofijo'],['#pasivo'],2); sumar_valores_inputs('#patrimonio',['#actcirculante','#activofijo'],['#pasivo'],2); sumar_valores_inputs('#pasivototal',['#pasivo','#patrimonio'],[],1);" placeholder="Cuentas por cobrar">
                                            <label for="cuentascobrar">Cuentas por cobrar</label>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-floating mb-1 mt-1">
                                            <input type="number" step="0.01" class="form-control" id="inventario" onkeyup="sumar_valores_inputs('#actcirculante',['#disponible','#cuentascobrar','#inventario'],[],2); sumar_valores_inputs('#activototal',['#actcirculante','#activofijo'],[],1); sumar_valores_inputs('#saldo2',['#actcirculante','#activofijo'],['#pasivo'],2); sumar_valores_inputs('#patrimonio',['#actcirculante','#activofijo'],['#pasivo'],2); sumar_valores_inputs('#pasivototal',['#pasivo','#patrimonio'],[],1);" placeholder="Inventario">
                                            <label for="inventario">Inventario</label>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-floating mb-2 mt-1">
                                            <input type="number" step="0.01" class="form-control" id="activofijo" onkeyup="sumar_valores_inputs('#actcirculante',['#disponible','#cuentascobrar','#inventario'],[],2); sumar_valores_inputs('#activototal',['#actcirculante','#activofijo'],[],1); sumar_valores_inputs('#saldo2',['#actcirculante','#activofijo'],['#pasivo'],2); sumar_valores_inputs('#patrimonio',['#actcirculante','#activofijo'],['#pasivo'],2); sumar_valores_inputs('#pasivototal',['#pasivo','#patrimonio'],[],1);" placeholder="Activo fijo">
                            ...
                            <div class="col-12 col-sm-6 col-md-4 mb-2 border border-primary">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="text-center mb-2"><span class="badge text-bg-primary" id="pasivototal">Q. 0.00</span></div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-floating mb-1 mt-1">
                                            <input type="number" step="0.01" class="form-control" id="pasivo" placeholder="Pasivo" readonly disabled>
                                ...
                                <div class="col-12">
                                    <div class="form-floating mb-1 mt-1">
                                        <input type="number" step="0.01" class="form-control" id="proveedores" onkeyup="sumar_valores_inputs('#pasivo',['#proveedores','#otrosprestamos','#prestamosinstituciones'],[],2); sumar_valores_inputs('#patrimonio',['#actcirculante','#activofijo'],['#pasivo'],2); sumar_valores_inputs('#pasivototal',['#pasivo','#patrimonio'],[],1); sumar_valores_inputs('#saldo2',['#actcirculante','#activofijo'],['#pasivo','#patrimonio'],2);" placeholder="Proveedores">
                                        <label for="proveedores">Proveedores</label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-floating mb-1 mt-2">
                                        <input type="number" step="0.01" class="form-control" id="otrosprestamos" onkeyup="sumar_valores_inputs('#pasivo',['#proveedores','#otrosprestamos','#prestamosinstituciones'],[],2);  sumar_valores_inputs('#patrimonio',['#actcirculante','#activofijo'],['#pasivo'],2); sumar_valores_inputs('#pasivototal',['#pasivo','#patrimonio'],[],1); sumar_valores_inputs('#saldo2',['#actcirculante','#activofijo'],['#pasivo','#patrimonio'],2);" placeholder="Otros préstamos">
                                        <label for="otrosprestamos">Otros préstamos</label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-floating mb-1 mt-2">
                                        <input type="number" step="0.01" class="form-control" id="prestamosinstituciones" onkeyup="sumar_valores_inputs('#pasivo',['#proveedores','#otrosprestamos','#prestamosinstituciones'],[],2); sumar_valores_inputs('#patrimonio',['#actcirculante','#activofijo'],['#pasivo'],2); sumar_valores_inputs('#pasivototal',['#pasivo','#patrimonio'],[],1); sumar_valores_inputs('#saldo2',['#actcirculante','#activofijo'],['#pasivo','#patrimonio'],2);" placeholder="Préstamos a instituciones">
                                        <label for="prestamosinstituciones">Préstamos a instituciones</label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-floating mb-2 mt-2">
                                        <input type="number" step="0.01" class="form-control" id="patrimonio" placeholder="Patrimonio">
                            ...
                            <div class="col-12 col-sm-12 col-md-4 mb-2 border border-primary">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-floating mb-2 mt-2">
                                            <input type="number" class="form-control" id="saldo2" placeholder="Saldo" readonly disabled>
                    ...
                    <div class="row justify-items-md-center">
                        <div class="col align-items-center mb-3 ms-2" id="modal_footer">
                            ...
                            <?php if ($bandera && count($datosbalances) <= 2) { ?>
                                <button id="save" class="btn btn-outline-success mt-2" onclick="obtiene_plus([`codcli`,`nomcli`,`ventas`,`cporcobrar`,`mercaderia`,`gastosporcobrar`,`pagoscreditos`,`disponible`,`cuentascobrar`,`inventario`,`activofijo`,`proveedores`,`otrosprestamos`,`prestamosinstituciones`,`patrimonio`,`saldo2`,`fecevaluacion`,`fecbalance`],[],[],`create_balance_economico`,'<?= $xtra; ?>',['<?= $codusu; ?>'])"><i class="fa-solid fa-floppy-disk me-2"></i>Guardar</button>
                            <?php } else {
                            ...
                            <?php if ($bandera_balance && $bandera) { ?>
                                <div id="divbuttons" style="display: none;">
                                    <button id="btupdate" class="btn btn-outline-primary mt-2"><i class="fa-solid fa-pen-to-square me-2"></i>Actualizar</button>
                                    ...
                                    <button id="btdelete" type="button" class="btn btn-outline-danger mt-2"><i class="fa-solid fa-trash me-2"></i>Eliminar</button>
                                </div>
            ...
            <script>
                ...
                function divbuttons(id, codcli) {
                    ...
                    $("#btupdate").click(function() {
                        obtiene_plus([`codcli`, `nomcli`, `ventas`, `cporcobrar`, `mercaderia`, `gastosporcobrar`, `pagoscreditos`, `disponible`, `cuentascobrar`, `inventario`, `activofijo`, `proveedores`, `otrosprestamos`, `prestamosinstituciones`, `patrimonio`, `saldo2`, `fecevaluacion`, `fecbalance`], [], [], `update_balance_economico`, codcli, [id]);
                    });
                ...
                function sumatorias() {
                    ...
                    sumar_valores_inputs('#ingresostotal', ['#ventas', '#cporcobrar'], [], 1);
                    sumar_valores_inputs('#saldo', ['#ventas', '#cporcobrar'], ['#mercaderia', '#gastosporcobrar', '#pagoscreditos'], 2);
                    //SEGUNDA PARTE
