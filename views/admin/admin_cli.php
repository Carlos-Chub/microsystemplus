...
?>
  <!DOCTYPE html>
  <html lang="en" style="background: #707070;">
  ...
  <body class="<?= ($_SESSION['background'] == '1') ? 'dark' : ''; ?>">
    <?php require '../../src/menu/menu_admin.php'; ?>
    ...
    <section class="home">
      <div class="container" style="max-width: none !important;">
        ...
        WHERE tbu.id_usu=" . $_SESSION['id'] . " AND AND tbo.estado='1' AND tbs.estado='1' AND tbm.estado='1' AND tbps.estado='1' AND
          tbps.id_cooperativa=(SELECT ag1.id_institucion FROM tb_agencia ag1 LIMIT 1) 
        AND tbo.rama='A' AND tbo.id=12 ORDER BY tbo.orden, tbs.orden, tbm.orden ASC";
    ...
    include_once "../../src/cris_modales/mdls_cli.php";  ?>
  </body>
