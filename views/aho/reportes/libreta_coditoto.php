...
$confirma="0";
$array[]=[];
$noprint =  mysqli_query($conexion, "SELECT `dfecope`,`cnumdoc`,`ctipope`,`monto`,`numlinea`,`correlativo` FROM `ahommov` WHERE cestado!=2 AND `ccodaho`='$ccodaho' AND `nlibreta`=$libreta AND `lineaprint`='N'");
