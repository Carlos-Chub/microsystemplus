...
$confirma="0";
$array[]=[];
$noprint =  mysqli_query($conexion, "SELECT `dfecope`,`cnumdoc`,`ctipope`,`monto`,`numlinea`,`correlativo` FROM `ahommov` WHERE `ccodaho`='$ccodaho'  AND cestado!=2 AND `nlibreta`=$libreta AND `lineaprint`='N'");
