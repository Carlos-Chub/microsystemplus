...
function printpdf($registro)
{
    ...
    while ($fila < count($registro)) {
        ...
        $codcli = utf8_encode($registro[$fila]["codcli"]);
        $nombre = utf8_encode($registro[$fila]["nomcli"]);
        $tipope = utf8_encode($registro[$fila]["tipope"]);
        $fecha = date("d-m-Y", strtotime(utf8_encode($registro[$fila]["fecope"])));
        $numdoc = utf8_encode($registro[$fila]["numdoc"]);
        $tipdoc = utf8_encode($registro[$fila]["tipdoc"]);
        $monto = utf8_encode($registro[$fila]["monto"]);
        $saldo = utf8_encode($registro[$fila]["saldo"]);
        $saldoant = utf8_encode($registro[$fila]["saldoant"]);
        $dias = utf8_encode($registro[$fila]["dias"]);
        $tasa = utf8_encode($registro[$fila]["tasa"]);
        $interes = utf8_encode($registro[$fila]["intcal"]);
        $isr = utf8_encode($registro[$fila]["isrcal"]);
        $tipocuenta = utf8_encode($registro[$fila]["nombre"]);
