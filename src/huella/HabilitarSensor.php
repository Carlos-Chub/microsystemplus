...
while ($fecha_bd <= $fecha_actual) {
    ...
    if ($elapsedTime == 350) {//modificar aqui si se requiere reiniciar em menos tiempo
        break;
    }
}

$query = "Select fecha_creacion, opc, pc_serial from huellas_temp where pc_serial = '" . $token . "' ORDER BY id DESC LIMIT 1";
