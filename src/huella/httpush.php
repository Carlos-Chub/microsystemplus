...
require_once './bd.php';
set_time_limit(0);
date_default_timezone_set("America/Guatemala");//Se tiene que cambiar por el nombre del pais donde esta utlian
...
$sql = "SELECT pc_serial,imgHuella,update_time,texto,statusPlantilla,documento,nombre, opc" . " FROM huellas_temp ORDER BY update_time DESC LIMIT 1";
$rows = $conn->findAll($sql);
