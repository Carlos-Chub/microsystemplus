...
$update_estado  = "SET @codcreditoupdate = '$codcreditoupdate';
    UPDATE cremcre_meta cm3 SET cm3.Cestado = 'x' WHERE cm3.CCODCTA COLLATE utf8mb4_general_ci = @codcreditoupdate;
    ...
    DELETE FROM ctb_mov WHERE id_ctb_diario = (SELECT cd.id FROM ctb_diario cd WHERE cd.cod_aux COLLATE utf8mb4_general_ci = @codcreditoupdate);
    DELETE FROM ctb_chq WHERE id_ctb_diario = (SELECT cd.id FROM ctb_diario cd WHERE cd.cod_aux COLLATE utf8mb4_general_ci = @codcreditoupdate);
