...
$NCiclo = isset($_POST['NCiclo']) ? $_POST['NCiclo'] : '';
    ...
    $sql_queries = "
        ...
        UPDATE cremcre_meta cm3 SET cm3.Cestado = 'X' WHERE cm3.CCodGrupo COLLATE utf8mb4_general_ci = @codgrupo AND cm3.NCiclo COLLATE utf8mb4_general_ci = @ciclogrupo;
