                  ...
                  $("#tbFiador").DataTable({
                      ...
                      columns: [
                        ...
                        },
                        {
                          ...
                          render: function(data, type, row) {
                            ...
                            var imp = `<button type="button" class="btn btn-primary" onclick="capfiador(${"'"+dataRow+"'"})">Seleccionar</button>`;
                            return imp;
                      ...
                      "fnServerParams": function(aoData) {
                        //PARAMETROS EXTRAS QUE SE LE PUEDEN ENVIAR AL SERVER ASIDE
                         aoData.push({"name": "whereextra","value": "idcod_cliente !=" + codFiador});
                      },
                      "bDestroy": true,
                      "language": {
                        "lengthMenu": "Mostrar _MENU_ registros",
            ...
            <div class="container mt-3 table-responsive">
              ...
              <table class="table" id="tbcuentaYcli">
                ...
                <tbody>
                  <!-- INI de la información -->
                  <?php
                  $consulta = mysqli_query($conexion, "SELECT credi.CCODCTA AS codCu, cli.short_name AS nombre, credi.NCapDes AS capDes from
                  tb_cliente AS cli 
