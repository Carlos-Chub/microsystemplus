        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="table-responsive">
                    <table id="tabla_clientes_a_solicitar" class="table table-striped table-hover" style="width: 100% !important;">
                        <thead>
                            <tr>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger" id="" onclick="cerrar_modal('#modal_solicitud_01', 'hide', '#id_modal_hidden')">Cerrar</button>
            </div>
        </div>
    </div>
</div>
